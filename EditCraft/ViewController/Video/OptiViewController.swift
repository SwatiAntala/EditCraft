...
//    var cropSlidervw: OptiRangeSliderView!
    ...
    override func viewDidLoad() {
        ...
        title = R.string.localizable.editVideo()
...
//        print("rangeSlider.upperValue", rangeSlider.upperValue)
        ...
        DispatchQueue.main.async {
            ...
            alert.addAction(UIAlertAction(title: "Continue", style: UIAlertAction.Style.default, handler: { action in
                if let videourl = self.slctVideoUrl {
                    ...
                    if getalbum {
                        OptiVideoEditor().save(videoUrl: videourl, toAlbum: "Video Editor", completionHandler: { (saved, localIdentifier, error) in
                            DispatchQueue.main.async {
                                if saved {
                                    ...
                                    self.saveData(videourl: videourl, 
    ...
    func saveData(videourl: URL, 
                  localIdentifier: String) {
        
        let duration = videourl.getVideoDuration()
    
        let image = videourl.generateThumbnail()?.pngData() ?? R.image.ic_video_placeholder()?.pngData()
        
        DatabaseManager.sharedInstance.addECVideo(ECVideo(url: videourl.absoluteString,
                                                          thumImage: image,
